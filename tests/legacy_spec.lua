...
describe("build", function()
	...
	it("pos", function()
		...
		assert(move("singleplayer", "move player1 to 0,1,2"))
		assert(move("singleplayer", "move player1 to (0,1,2)"))
		assert(move("singleplayer", "move player1 to 0, 1,2"))
		assert(move("singleplayer", "move player1 to 0 ,1, 2"))
		assert(move("singleplayer", "move player1 to 0, 1, 2"))
		assert(move("singleplayer", "move player1 to 0 ,1 ,2"))
		assert(move("singleplayer", "move player1 to ( 0 ,1 ,2)"))
		assert(not move("singleplayer", "move player1 to abc,def,sdosd"))
		assert(not move("singleplayer", "move player1 to abc def sdosd"))
	...
	it("number", function()
		...
		assert.equal(-3.3, checknegnumber("checker","checknegnumber -3.3"))
	end)
	...
	it("types", function()
		...
		local int, number, pos, word, text =
			checktypes("checker","checktypes -1 -2.4 (-3,-5.3,6.12)  some text  to finish off with")
